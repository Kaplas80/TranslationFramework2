...
namespace TFGame.TrailsSky.Files.Exe
{
    public class File : BinaryTextFile
    {
        ...
        protected virtual Dictionary<int, List<int>> StringOffsets => new Dictionary<int, List<int>>()
        {
            ...
            {0x0015C468, new List<int>() {0x00015A94, 0x000223BA}},
            {0x0015C470, new List<int>() {0x00015ED4, 0x00016156}},
            {0x0015C47C, new List<int>() {0x00016077}},
            {0x0015C484, new List<int>() {0x0001604E}},
            {0x0015C490, new List<int>() {0x00016024}},
            {0x0015C49C, new List<int>() {0x0001610C}},
            {0x0015C4A8, new List<int>() {0x00016137}},
            {0x0015C4B0, new List<int>() {0x000160DF}},
            {0x0015C4B8, new List<int>() {0x000161E4}},
            {0x0015C4C0, new List<int>() {0x000161BE}},
            {0x0015C4CC, new List<int>() {0x00016198}},
            {0x0015C4D4, new List<int>() {0x0001620A}},
            {0x0015C4E0, new List<int>() {0x000162C9}},
            {0x0015C4E8, new List<int>() {0x000162A6}},
            {0x0015C4F4, new List<int>() {0x0001625E}},
            {0x0015C564, new List<int>() {0x00021E58, 0x00021F67, 0x00022052}},
            {0x0015C56C, new List<int>() {0x000223DE}},
            {0x0015C578, new List<int>() {0x000228A3}},
